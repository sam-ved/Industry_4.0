...
export default function ModelsHub() {
  ...
  useDocumentMeta('Models Hub', 'Select from 9 AI models for industrial analysis — upload data, run inference, and view analytics.')
  const {
    models,
    selectedModel,
    file,
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen bg-slate-950 text-white overflow-hidden relative">
      <BackgroundGlow />
      
      {/* Left Sidebar — Model Selector (hidden on mobile) */}
      <div className="hidden lg:flex w-80 border-r border-slate-800/60 bg-slate-900/40 backdrop-blur-md flex-col z-10 relative shadow-[4px_0_24px_rgba(0,0,0,0.2)]">
        <ModelSelector
          models={models}
      ...
      <div className="flex-1 flex flex-col overflow-hidden z-10 relative">
        {/* Header */}
        <header className="bg-slate-900/50 backdrop-blur-lg border-b border-slate-800/60 px-4 sm:px-8 py-5 flex items-center justify-between shadow-sm">
        ...
        <div className="lg:hidden px-4 py-3 border-b border-slate-800/60 bg-slate-900/30 backdrop-blur-md overflow-x-auto">
      ...
      {/* Right Sidebar — Analytics (hidden on mobile) */}
      <div className="hidden lg:flex w-80 border-l border-slate-800/60 bg-slate-900/40 backdrop-blur-md flex-col z-10 relative shadow-[-4px_0_24px_rgba(0,0,0,0.2)]">
